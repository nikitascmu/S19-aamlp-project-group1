...
final_df <- final_df %>% select(-c('race_White','gender_No.Data.and.Other','most_presc_drug_TRAMADOL','most_dose_form_PILL',
                                   'race_American.Indian.Alaskan.Native','cohort','pill_count','race_Asian',
                                   'most_presc_drug_OTHER','total_acj','most_presc_drug_HYDROMORPHONE'))
...
table(xtest$target,pred_balanced_logistic_cv>0.2)
...
table(xtest$target,pred_balanced_gbm$'1'>0.2)
