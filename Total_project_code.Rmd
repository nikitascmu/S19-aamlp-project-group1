...
## Data Cleaning: Fixing Days Supply
```{r}
...
### Some drugs and dosage form counts are much less so there is no need to keep them as a separate category. Here we create a separate category for "Other" in which we combine all such categories.
